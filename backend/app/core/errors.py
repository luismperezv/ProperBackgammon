...
class InvalidMoveError(GameError):
    def __init__(self, message: str = "Invalid move", details: Optional[Dict[str, Any]] = None):
        super().__init__(status_code=400, message=message, details=details)

class GameNotFoundError(GameError):
    def __init__(self, message: str = "Game not found", details: Optional[Dict[str, Any]] = None):
